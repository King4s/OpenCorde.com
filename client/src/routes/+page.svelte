<script lang="ts">
  /**
   * @file Home/Login page — shows login or redirects to servers
   * @purpose Combined entry point and login
   */
  import { goto } from '$app/navigation';
  import { onMount } from 'svelte';
  import { restoreSession, login as doLogin } from '$lib/stores/auth';
...
{:else}
  <div class="flex items-center justify-center min-h-screen bg-gray-900">
    <div class="w-full max-w-md p-8 bg-gray-800 rounded-lg shadow-xl">
      <h1 class="text-2xl font-bold text-white mb-2">Welcome to OpenCorde</h1>
